...
alias start_server='awake AC162d849893'
# alias sudo='doas'
...
# Command to get rid of all docker containers
alias docker-purge='for hash in $(sudo docker ps | cut -d " " -f 1 | tail -n +2); do sudo docker rm -f $hash; done'
